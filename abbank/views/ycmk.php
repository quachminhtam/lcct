...
<body>
    ...
    <div class="container" style="justify-content:space-between;">
        <h3 style="text-align: center; margin-top: 1rem;">Yêu cầu cấp lại mật khẩu</h3>    
        <form action="xulyyeucau.php" method="post" class="form">
            ...
            <div class="form-group">
                <label class="col-form-label" style="font-size: 20px;">Nhập thông tin tài khoản để xác nhận: </label>
                <textarea class="form-control" name="noi_dung"></textarea>
            </div>
            <div class="img_row">
                <input type="submit" name="yeucaumk" value="Gửi yêu cầu">
            </div> 
        </form>
    </div>
