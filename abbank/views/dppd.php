...
<body>
    ...
    <div class="container-fluid tab-content">
        <h1 style="margin: 1rem 0">Danh sách hồ sơ</h1>
        <?php
         $query = "SELECT hs_td.*  FROM hs_td INNER JOIN (
            ...
            ) AS tb2 ON hs_td.ma_hs = tb2.ma_hs WHERE ma_tt = 'dieupheduyet' ";
            ...
            <tbody> ";
                ...
                echo"
                    <tr>
                        ...
                        <td>
                        <a href='hsdppd.php?id=".$hs['ma_hs']."'>  <input type='button' value='Chọn'> 
                        </td>
                    </tr>
                ";}
