...
<body>
    ...
    <div class="container-fluid" style="justify-content:space-between; margin-bottom: 2rem;">
        ...
        <div class="row" style="justify-content:space-between; padding-right: 2rem">
            ...
            <button type="button" class="col btn btn-x" data-toggle="modal" data-target="#huysoan">Hủy soạn thảo</button>
            <button type="button" class="col btn btn-x" data-toggle="modal" data-target="#luuhoso">Lưu hồ sơ</button>
            <button type="button" class="col btn btn-x" data-toggle="modal" data-target="#trinhhoso">Trình hồ sơ</button>
        </div>
